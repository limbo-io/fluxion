...
public class LoadBalanceException extends RuntimeException {
    ...
    public static Supplier<LoadBalanceException> supplier(String message) {
        return () -> new LoadBalanceException(message);
    }

    public static Supplier<LoadBalanceException> supplier(String message, Throwable cause) {
        return () -> new LoadBalanceException(message, cause);
    }
}
