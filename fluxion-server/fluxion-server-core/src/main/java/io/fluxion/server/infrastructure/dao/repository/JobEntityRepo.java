 ...
 */
@Repository
public interface JobEntityRepo extends JpaRepository<JobEntity, String> {

    JobEntity findByExecutionIdAndRefIdAndJobType(String executionId, String refId, String jobType);
